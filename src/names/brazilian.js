...
export const femaleFirstNames = [
  ...
  'Ariana', 'Ashley', 'Bárbara', 'Beatriz', 'Bianca', 'Camila', 'Carla', 'Carolina', 'Catarina', 'Clara', 'Daniela', 'Elizabeth', 'Emília',
...
export const lastNames = [
  ...
  'Montenegro', 'Neves', 'Nunes', 'Oliveira', 'Ortega', 'Ortiz', 'Quintana',
